...
public class GetUserInfo {
	 ...
	 * This class will read the UserData.txt file and 
         * convert all the users' information into an array list.
	 */
	public static ArrayList<GetLoginInfo> getuserinfo(String FilePath)
	{
		ArrayList<GetLoginInfo> userinfo =new ArrayList<GetLoginInfo>();
		...
		try
		{
			...
			while (scanner.hasNext())
			{
				...
				GetLoginInfo TempUser = new GetLoginInfo(
