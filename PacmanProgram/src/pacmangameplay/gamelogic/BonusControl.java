...
import pacmangameplay.charactercontrol.Pacman;
...
public class BonusControl {
    ...
    private static int bonusesEaten;
    public BonusSymbol bonus1;
    public BonusSymbol bonus2;
    private double bonusTimer;
    
    private Pacman pacman;
    
    
    public BonusControl(Characters characters, LevelSpecs levelSpecs, int level){
        currentLevel = level;
    ...
    private boolean pacEatingBonus(){
        return (ToleranceEquals.positionCheck(pacman.getX(),bonus1.getXPos()) && ToleranceEquals.positionCheck(pacman.getY(), bonus1.getYPos()));
    }
