 ...
 * A counter can be turned on or off (enabled/disabled) or temporarily suspended (activated/deactivated). 
 * Every counter has a limit associated to it, which is used to trigger status changes.
 * @author stavy92
 */
