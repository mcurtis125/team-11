...
import pacmangameplay.charactercontrol.GhostControl;
import pacmangameplay.charactercontrol.Characters;
import pacmangameplay.charactercontrol.CharacterCollisionChecker;
...
public class LevelLogic {
    ...
    //level specs
    public LevelSpecs levelSpecs = new LevelSpecs();
      
    public Maze maze;
    public Characters characters;
    CharacterCollisionChecker collisionCheck;
    ...
    public LevelLogic(Characters characters, Maze maze) {
        this.maze = maze;
        this.characters = characters;
        collisionCheck= new CharacterCollisionChecker(characters);       
    }
...
//        System.out.println("Game start");
        ...
        this.bonusControl = new BonusControl(characters, levelSpecs, currentLevel);
    ...
    private void checkCollision(){
        ...
        if(collisionCheck.pacmanGhostCollisionCheck()!=null){
            try{ 
