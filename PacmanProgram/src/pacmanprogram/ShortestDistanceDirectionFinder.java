 ...
 * @author Kevin
 */
public class ShortestDistanceDirectionFinder {
    
    WallCollisionChecker wallCollsionChecker = new WallCollisionChecker();
    public enum nextDirection{up, down, left, right, none};
    
    public ShortestDistanceDirectionFinder(){
    }
    
    
    public ShortestDistanceDirectionFinder.nextDirection chooseNextTile(double ghostXCoordinate, double ghostYCoordinate, double targetXCoordinate, double targetYCoordinate, double velx, double vely){
